...
type DivideFoodError struct {
}

func (e *DivideFoodError) Error() string {
	return "amount could not be determined"
}
...
func DivideFood(fc FodderCalculator, cows int) (float64, error) {
	...
	if err != nil {
		return 0, &DivideFoodError{}
	}
	return amount * fatFactor / float64(cows), nil
}
